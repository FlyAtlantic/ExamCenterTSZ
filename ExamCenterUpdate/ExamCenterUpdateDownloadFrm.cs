...
{
    internal partial class ExamCenterUpdateDownloadFrm : Form
    {
        ...
        internal ExamCenterUpdateDownloadFrm(Uri location, string md5, Icon programIcon)
        {
            InitializeComponent();
        ...
        private void ExamCenterUpdateDownloadFrm_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (webClient.IsBusy)
            {
